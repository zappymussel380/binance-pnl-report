...
class ScenarioTest {
  ...
  void testScenario() {
    ...
    expectWalletState(ws2, 1, "1.65167383", "72.22", "0");
    expectPnl(ws2, "0", "0");

    WalletSnapshot ws3 = processSell(ws2, "LTC", "0.65167000",
        "47.115741", "0.04711574", "USDT");
    expectWalletState(ws3, 2, "1.00000383", "72.22", "47.06862526");
    expectPnl(ws3, "0.00501786", "0.00501786");

    WalletSnapshot ws4 = processSell(ws3, "LTC", "1.00000000",
        "72.30000000", "0.07230000", "USDT");
    expectWalletState(ws4, 2, "0.00000383", "72.22", "119.29632526");
    expectPnl(ws4, "0.00770000", "0.01271786");
  }
